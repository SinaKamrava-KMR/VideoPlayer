...
import static com.example.videopayer.VideoFilesActivity.MY_PREF;
...
public class PlayListDialog extends BottomSheetDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        String folder_name=sharedPreferences.getString("playListFolderName","abc");

        arrayList=fetchMedia(folder_name);
    ...
    private ArrayList<MediaFiles> fetchMedia(String folderName) {
        ...
        Cursor cursor=getContext().getContentResolver().query(uri,null,selection,selectionArg
                ,null);
